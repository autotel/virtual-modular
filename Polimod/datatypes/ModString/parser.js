...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c1 = function(from, connection) {
          		//console.log({head,connection})
          		if(connection){
                	let localFrom=from;
                	connection.forEach((connection)=>{
                		console.log(localFrom+".connectTo("+connection.to+")");
                    	localFrom=connection.to;
                    })
                }
          		return {from}
            },
        peg$c2 = function(connector, to) {
                return {connector,to}
            },
        peg$c3 = peg$otherExpectation("connector"),
        peg$c4 = /^[\-]/,
        ...
        peg$c14 = function(reference) {
          	return reference;
          },
        peg$c15 = peg$otherExpectation("object reference"),
        peg$c16 = /^[0-9A-Za-z.]/,
        peg$c17 = peg$classExpectation([["0", "9"], ["A", "Z"], ["a", "z"], "."], false, false),
